...
fn speak_kokoro_native(
    ...
    let is_exempt = is_cached.unwrap_or(false)
        || text.contains("Voxify Audio Pill is running")
        || text.contains("Hi, I'm Sarah");

    if !is_exempt && global_reader::is_speech_blocked_by_quota() {
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            global_reader::set_master_enabled,
            global_reader::get_master_enabled,
